...
export class RosterComponent implements OnInit {
  ...
  dataSource$: Player [] = [
    ...
    {name: 'Juliano', surname: 'Jubs', celular: '(62)999429-1748', position: 'Goleiro', qntEstrelas: 4, idade: 21, email: 'buttielle3@gmail.com', numberList: 5, caminhofoto: '../../assets/juliano.png'}
  ];
